...
<head>
    ...
    <title>Balap - @yield('title', 'Website')</title>
...
<body>
    <nav class="navbar navbar-expand-lg bg-warning" data-bs-theme="dark">
        <div class="container">
            <a class="navbar-brand" href="/">BALAPAN</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    @auth
                        <li class="nav-item">
                            <a class="nav-link" href="/balaps/data">Master Pembalap Motogp</a>
                        </li>
                    @endauth
                </ul>
    ...
    <footer class="bg-warning text-center text-white py-2">
        Copyright &copy; 2023 by M.REZA ATHAULLAH
    </footer>
